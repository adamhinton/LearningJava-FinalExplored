...
public class MainMailer {
    ...
    public static void main(String[] args) {
        ...
        List<StringBuilder> cleanedNames = standadizeNames(population);
    ...
    // Remove suffixes for privacy purposes
    private static List<StringBuilder> standadizeNames (List<StringBuilder> list){
